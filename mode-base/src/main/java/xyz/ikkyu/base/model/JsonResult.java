...
//    @JsonIgnore
    ...
    public static JsonResult of(Exception ex) {
        return ex instanceof BusinessException ?
                new JsonResult(((BusinessException)ex).getCode(), ((BusinessException)ex).getDescription(), ex.getMessage())
                : new JsonResult(CommonExceptions.SERVER_ERROR.getCode(), ex.getMessage());
    }
