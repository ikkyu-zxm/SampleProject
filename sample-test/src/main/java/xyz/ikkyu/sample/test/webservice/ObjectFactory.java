 ...
 * generated in the cn.ikkyu.sample.test.webservice package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.ikkyu.sample.test.webservice
     * 
     */
