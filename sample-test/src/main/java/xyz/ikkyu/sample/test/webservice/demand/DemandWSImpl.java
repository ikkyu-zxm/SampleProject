package xyz.ikkyu.sample.test.webservice.demand;

import xyz.ikkyu.sample.test.domain.RpcRst;
import xyz.ikkyu.sample.test.domain.SapDemandWsVo;
...
@WebService(serviceName = "demandWS",
        ...
        endpointInterface = "xyz.ikkyu.sample.test.webservice.demand.DemandWS")
